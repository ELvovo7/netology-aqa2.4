...
import static pages.MyAccountPage.balance0002;
...
public class TransferPage {
    ...
    MyAccountPage sl = new MyAccountPage();

    public void transferToFirstCard() {
        int card1Balance = MyAccountPage.balance0001();// запомнили начальный баланс нарты 1
        int card2Balance = balance0002();// запомнили начальный баланс карты 2
        sl.selectTransferToFirstCard(); //нажали кнопку пополнить карту 1
    ...
    public void transferToSecondCard() {
        ...
        sl.selectTransferToSecondCard(); //жмем кнопку пополнить карту 2
